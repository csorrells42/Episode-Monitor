...
public sealed class PersonalFaceModelBuilder
{
    ...
    private static string GetTrackingArtifactReason(FaceLandmarkMetrics metrics)
    {
        ...
        {
            return "eye contour was reconstructed; wait for direct eyelid lock before avatar learning";
        }

        if (metrics.MouthReconstructed)
        {
            return "mouth contour was reconstructed; wait for direct lip/jaw lock before avatar learning";
        }
