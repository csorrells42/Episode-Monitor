...
internal static class Nv12FrameConverter
{
    ...
    public static byte[]? ConvertToBgra(
        byte[] nv12,
        int nv12Stride,
        int width,
        int height,
